...
class TransactionTest {
	...
	Transaction transaction2 = new Transaction(1l, 1l, "Rishabh", 3l, "Vishal", 1000, null, "deposit");
	...
	void setTargetOwnerNameTest() {
		transaction.setTargetOwnerName("Rishabh");
		assertEquals("Rishabh", transaction.getTargetOwnerName());
	}
